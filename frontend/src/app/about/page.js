      ...
      <div className="max-w-4xl mx-auto space-y-8">
        <div className="space-y-6">
          ...
          <div className="text-gray-600 space-y-4">
            <p>
              O OpenPages é uma plataforma desenvolvida especialmente para a
              comunidade acadêmica da FATEC, oferecendo acesso centralizado aos
              recursos bibliográficos dos diferentes cursos da instituição.
            </p>
            <p>
              Nossa plataforma permite que estudantes consultem a
              disponibilidade de livros, solicitem empréstimos, façam sugestões
              de novas aquisições e tenham acesso facilitado aos materiais
              essenciais para sua formação acadêmica.
            </p>
            <p>
              Com um design minimalista e acadêmico, o OpenPages prioriza a
              usabilidade e a eficiência, garantindo que os usuários encontrem
              rapidamente as informações que precisam para seus estudos e
              pesquisas.
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 bg-white rounded-lg border border-gray-200">
              ...
              <p className="text-gray-600 text-sm">
                Recursos focados em programação, engenharia de software e
            ...
            <div className="p-4 bg-white rounded-lg border border-gray-200">
              ...
              <p className="text-gray-600 text-sm">
                Bibliografia especializada em análise de sistemas, modelagem e
                desenvolvimento.
              </p>
            </div>
            <div className="p-4 bg-white rounded-lg border border-gray-200">
              ...
              <p className="text-gray-600 text-sm">
                Materiais sobre gestão, produção industrial e otimização de
                processos.
              </p>
            </div>
            <div className="p-4 bg-white rounded-lg border border-gray-200">
              ...
              <p className="text-gray-600 text-sm">
                Livros sobre gestão de pessoas, psicologia organizacional e
                administração.
              </p>
            </div>
          </div>
              ...
              <table className="w-full">
                ...
                <tbody className="divide-y divide-gray-200">
                  <tr className="hover:bg-gray-50/50">
                    ...
                    <td className="px-6 py-4 text-gray-600">
                      Visão do produto, priorização, back-end, autenticação e
                      integração.
                    </td>
                  </tr>
                  <tr className="hover:bg-gray-50/50">
                    ...
                    <td className="px-6 py-4 text-gray-600">Desenvolvedor</td>
                    <td className="px-6 py-4 text-gray-600">
                      Implementação front-end, UX/UI e integração do sistema de
                      login.
                    </td>
                  </tr>
                </tbody>

    ...
    <div className="space-y-20">
      ...
      <div className="text-center space-y-8 pt-12 pb-8">
        ...
        <p className="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed font-light">
          Sua plataforma de livros acadêmicos da FATEC. Explore recursos
          bibliográficos, consulte disponibilidade, solicite empréstimos e
          contribua com sugestões para enriquecer nossa biblioteca.
        </p>
        {user.role === "admin" && (
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200/50 rounded-2xl p-6 max-w-2xl mx-auto shadow-sm">
            <p className="text-blue-800 leading-relaxed">
              ...
              completo para gerenciar livros e visualizar todas as
        ...
        <div className="bg-gradient-to-br from-white to-gray-50/50 p-12 rounded-3xl border border-gray-200/50 shadow-sm text-center space-y-8">
          <div className="space-y-4">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
              Explore nosso catálogo de livros acadêmicos e encontre os recursos
              que você precisa para seus estudos.
            </p>
          </div>

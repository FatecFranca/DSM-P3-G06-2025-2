    ...
    <div className="container mx-auto px-3 sm:px-4 md:px-6 py-4 sm:py-6 md:py-8">
      <div className="flex flex-col gap-3 sm:gap-4 mb-6 sm:mb-8">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 sm:gap-4">
          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold truncate">Gerenciar Usuários</h1>
          <Button
            onClick={() => handleOpenDialog()}
            className="flex items-center justify-center gap-1.5 sm:gap-2 text-sm whitespace-nowrap"
          >
            <Plus className="h-3.5 w-3.5 sm:h-4 sm:w-4" />
            <span className="hidden xs:inline">Adicionar Usuário</span>
      ...
      <Card className="p-3 sm:p-4 mb-4 sm:mb-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          ...
          <div>
            <label className="block text-xs sm:text-sm font-medium mb-1">Perfil</label>
            <select
              name="perfil"
          ...
          <div>
            <label className="block text-xs sm:text-sm font-medium mb-1">Curso</label>
            <select
              name="curso_id"
